            ...
            with ui.row().classes("w-full flex-nowrap"):
                with ui.column().classes("min-w-[250px]"):
                    ...
                    with self._tabs:
                        ...
                        self._tab["post_install_webhook"] = ui.tab(name="Post Installation Webhook").classes("text-secondary justify-self-end")
                        self._tab["first_boot"] = ui.tab(name="First Boot Hook").classes("text-secondary justify-self-end")
