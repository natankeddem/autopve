...
from autopve.tabs.settings import Global, Network, Disk, FirstBoot, Post
        ...
        with self._header:
            with ui.row().classes("w-full h-16 justify-between items-center"):
                ...
                with self._tabs:
                    ...
                    self._tab["first_boot"] = ui.tab(name="First-Boot").classes("text-secondary")
                    self._tab["post_install_webhook"] = ui.tab(name="Post-Webhook").classes("text-secondary")
